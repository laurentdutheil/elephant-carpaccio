...
func DefaultBacklog() Backlog {
	return Backlog{
		...
		{Id: "EC-003", Description: "Compute order value without tax", Score: NewScore(1, money.NewDollar(money.Decimal(100)))},
		{Id: "EC-004", Description: "Can handle float for 'number of items' AND 'price by item'", Score: NewScore(1, money.NewDollar(money.Decimal(100)))},
		{Id: "EC-005", Description: "Tax for UT", Score: NewScore(1, money.NewDollar(money.Decimal(5000000)))},
		{Id: "EC-006", Description: "Tax for NV", Score: NewScore(1, money.NewDollar(money.Decimal(2600000)))},
		{Id: "EC-007", Description: "Tax for TX", Score: NewScore(1, money.NewDollar(money.Decimal(1300000)))},
		{Id: "EC-008", Description: "Tax for AL", Score: NewScore(1, money.NewDollar(money.Decimal(700000)))},
		{Id: "EC-009", Description: "Tax for CA", Score: NewScore(1, money.NewDollar(money.Decimal(400000)))},
		...
		{Id: "EC-015", Description: "Can handle rounding for result (two digits after the decimal point)", Score: NewScore(1, money.NewDollar(money.Decimal(100)))},
		{Id: "EC-016", Description: "Prompts are clear. Display currency", Score: NewScore(1, money.NewDollar(money.Decimal(100)))},
		{Id: "EC-017", Description: "Display details (order value, tax, discount", Score: NewScore(1, money.NewDollar(money.Decimal(200)))},
